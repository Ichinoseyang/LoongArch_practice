module alu(
    ...
    // assign mul_a      = {{op_mulhu & alu_src1[31]}, alu_src1[31:0]};
    // assign mul_b      = {{op_mulhu & alu_src2[31]}, alu_src2[31:0]};
    // assign mul_c      = mul_a * mul_b;
    // assign mul_result = op_mul ? mul_c[31:0] : mul_c[63:32];
    ...
    // wire div_divisor_tvalid;
    // wire div_dividend_tready;
    // wire div_dividend_tvalid;
    ...
    //     .m_axis_dout_tdata      ({div_result[63:32], mod_result[31:0]}),
